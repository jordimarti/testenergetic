class IdentificacionsController < ApplicationController
  ...
  private
    ...
    def identificacio_params
      params.require(:identificacio).permit(:edifici_id, :tipus_via, :nom_via, :numero_via, :bloc, :codi_postal, :poblacio, :provincia, :periode_construccio, :any_construccio, :superficie_util, :nom_propietari, :cognoms_propietari, :tipus_document_identitat_propietari, :numero_document_identitat_propietari, :email_propietari, :tel_fix_propietari, :tel_mobil_propietari, :adreca_propietari, :codi_postal_propietari, :municipi_propietari, :tipus_projecte)
    end
end
